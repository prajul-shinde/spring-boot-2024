package com.omsai.spring6resttemplate.config;
...
public class RestTemplateBuilderConfig {
    ...
    OAuth2AuthorizedClientManager oAuth2AuthorizedClientManager(ClientRegistrationRepository clientRegistrationRepository, OAuth2AuthorizedClientService oAuth2AuthorizedClientService) {
        var oauthorizedClientProvider = OAuth2AuthorizedClientProviderBuilder
                .builder()
                .clientCredentials()
                .build();
        ...
        authorizedClientManager.setAuthorizedClientProvider(oauthorizedClientProvider);
